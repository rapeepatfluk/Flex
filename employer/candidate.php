...
<main class="container py-5"><a class="link-primary d-inline-block mb-4" href="<?= BASE_URL ?>/employer/candidates.php?job=<?= $jobId ?>">← กลับไปผลการค้นหา</a>
    <div class="row g-4"><div class="col-lg-8"><section class="card border-0 shadow-sm"><div class="card-body p-4 p-md-5">
        ...
        <h2 class="h5">ทักษะและความสามารถ</h2><div class="skills-wrap mb-4"><?php foreach (matching_names($candidate['skill_names']) as $skill): ?><span class="skill-tag"><?= e($skill) ?></span><?php endforeach ?><?php if (!$candidate['skill_names']): ?><span class="text-secondary">ยังไม่ได้ระบุทักษะ</span><?php endif ?></div>
