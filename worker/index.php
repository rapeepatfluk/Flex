...
$profileChecks = [
    ...
    'จังหวัดที่สะดวก' => !empty($matchingProfile['work_province']),
    'ประเภทงานที่สนใจ' => (int) ($matchingProfile['preference_count'] ?? 0) > 0,
    ...
    <section class="mt-5">
        <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-2 mb-4">
            <div>
                ...
                <?php if (!$hasMatchingProfile): ?><p class="text-secondary mb-0">เพิ่มทักษะ พื้นที่ และประเภทงานที่สนใจเพื่อรับคำแนะนำที่ตรงขึ้น</p><?php endif ?>
