...
try {
    ...
    $pdo->prepare("UPDATE job_invitations SET invitation_status='accepted',responded_at=COALESCE(responded_at,NOW()) WHERE job_id=? AND worker_user_id=? AND invitation_status IN ('sent','viewed')")
